...
import { FormPesquisaCirugia } from "../formBusca";
...
export const Cirugias = () => {
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            const { data } = await api.post("/cirugia", formData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
            toast.success("Cirugia criada com sucesso!");
    ...
    return (
        <DefaultTemplate>
            <section className={style.container}>
                ...
                <FormPesquisaCirugia buscarCadastro={buscarCadastro} setBuscarCadastro={setBuscarCadastro}/>
